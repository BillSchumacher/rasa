...
DOCS_URL_TRAINING_DATA = f"{DOCS_BASE_URL}/training-data-format"
DOCS_URL_TRAINING_DATA_NLU = f"{DOCS_URL_TRAINING_DATA}#nlu-training-data"
DOCS_URL_DOMAINS = f"{DOCS_BASE_URL}/domain"
DOCS_URL_SLOTS = f"{DOCS_URL_DOMAINS}#slots"
DOCS_URL_INTENTS = f"{DOCS_URL_DOMAINS}#intents"
DOCS_URL_ENTITIES = f"{DOCS_URL_DOMAINS}#entities"
DOCS_URL_RESPONSES = f"{DOCS_BASE_URL}/responses"
DOCS_URL_STORIES = f"{DOCS_BASE_URL}/stories"
DOCS_URL_RULES = f"{DOCS_BASE_URL}/rules"
DOCS_URL_FORMS = f"{DOCS_BASE_URL}/forms"
DOCS_URL_PIPELINE = f"{DOCS_BASE_URL}/tuning-your-model"
DOCS_URL_POLICIES = f"{DOCS_BASE_URL}/policies"
DOCS_URL_TEST_STORIES = f"{DOCS_BASE_URL}/testing-your-assistant"
DOCS_URL_MARKERS = f"{DOCS_BASE_URL}/markers"
DOCS_URL_ACTIONS = f"{DOCS_BASE_URL}/actions"
DOCS_URL_DEFAULT_ACTIONS = f"{DOCS_BASE_URL}/default-actions"
DOCS_URL_CONNECTORS = f"{DOCS_BASE_URL}/connectors/"
DOCS_URL_CONNECTORS_SLACK = f"{DOCS_URL_CONNECTORS}/slack"
DOCS_URL_EVENT_BROKERS = f"{DOCS_BASE_URL}/event-brokers"
DOCS_URL_PIKA_EVENT_BROKER = f"{DOCS_URL_EVENT_BROKERS}#pika-event-broker"
DOCS_URL_TRACKER_STORES = f"{DOCS_BASE_URL}/tracker-stores"
DOCS_URL_COMPONENTS = f"{DOCS_BASE_URL}/components"
DOCS_URL_GRAPH_COMPONENTS = f"{DOCS_BASE_URL}/custom-graph-components"
DOCS_URL_GRAPH_RECIPE = f"{DOCS_BASE_URL}/graph-recipe"
DOCS_URL_MIGRATION_GUIDE = f"{DOCS_BASE_URL}/migration-guide"
DOCS_URL_MIGRATION_GUIDE_MD_DEPRECATION = (
    f"{DOCS_URL_MIGRATION_GUIDE}#rasa-21-to-rasa-22"
)
DOCS_URL_TELEMETRY = f"{DOCS_BASE_URL}/telemetry/telemetry"
